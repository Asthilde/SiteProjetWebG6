...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 12 mai 2022 à 17:12
...
('0', 'A1', 35, 'Vert sur fond foncé', 0),
('0', 'A2', 13, 'L&#039;arche obscure', 0),
('0', 'A2', 35, 'Bleu sur fond blanc', -3),
('0', 'A3', 35, 'Noir sur fond rose', -3),
...
(35, 'Noémie et Justine en comm web', '', 'Noémie et Justine doivent réaliser un site web pour leur projet informatique. Les choix qu\'elles vont faire seront déterminants...', 1, 5, 2, 3, 0);
...
('0', 13, 'Bienvenue sur la planète Ziblub. A des années lumières du système solaire, ce monde abrite une civilisation pacifiste et bienveillante de grenouilles extraterrestres, vivant en parfaite harmonie avec l’écosystème environnant. Le rêve quoi. Enfin presque. Il se trouve que ces espèces de grenouilles, les Zelophylax, semblent encore avoir l’esprit un peu arriéré. En effet, la tradition veut que les Zelophylax mâles conquièrent l’organe cardiaque de leur dulcinée avec un sublime bouquet de fleurs exotiques. C’est la seule méthode de séduction prise au sérieux sur Ziblub. Autant vous dire que les jardiniers et fleuristes du coin sont vraiment blindés. ', 'Je vous présente Zoubi. Ce jeune adolescent est tombé fou amoureux il y a quelques jours de la petite nouvelle ayant débarqué dans son établissement scolaire. Elle s’appelle Zadie, possède un organe cérébral super développé, est très attentionnée envers ses petits camarades de classe, et, je cite Zoubi, elle est également “vraiment trop pipoudax”.Vous l’aurez compris, Zoubi a les zormones en feu est prêt à tout pour cette charmante demoiselle. Y compris de lui offrir le plus beau bouquet de fleurs qu’elle n’ait jamais vu. Cependant, les parents de Zoubi ne lui donnent pas d’argent de poche, et il n’a donc pas de quoi acquérir ces sublimes fleurs exotiques.', 'Toutefois, Zoubi n’est pas du genre à se dégonfler. Il sait que supplier ses parents ne sert à rien, mais il a une autre idée en tête pour aller trouver des fleurs colorées et parfumées. Muni juste d’un sac, et sûrement un peu trop candide, il part léger et court vêtu à la lisière de la forêt, où il est sûr de trouver ce qu’il désire tant.Notre jeune grenouille s’enfonce à travers les buissons, franchit des troncs d’arbres barrant sa route et laisse les rayons de lumières traversant les sapins réchauffer sa peau crapauteuse. Soudain, le sentier qu’il suivait jusqu’à présent se divise en trois. Stoïque, Zoubi scrute chaque chemin avec attention.', '    Le premier chemin l&#039;amène à une sorte de point d’eau. De ce dernier semble émaner une douce lumière bleutée.     L’entrée du deuxième chemin est faite d’arbres entrelacés, et forment une arche. Derrière, rien n’est perceptible à cause de la pénombre. On ne voit qu’une faible lueur orangée bouger.    Enfin, au bout du dernier chemin se dessine dans l’ombre une petite cabane, éclairée avec une lumière rose scintillante.    Quel chemin Zoubi doit-il prendre ?', '', 'img_0_1.jpg', 'img_0_2.jpg', 'img_0_3.jpg', 'img_0_4.jpg', ''),
('0', 35, 'Noémie et Justine doivent réaliser un site web accessible d&#039;elles-mêmes. Quelles couleurs vont-elles choisir ?', '', '', '', '', '', '', '', '', ''),
('A1', 13, 'Intrigué par cette douce couleur bleue, Zoubi empreinte le chemin l’amenant à ce point d’eau. Arrivant devant celui-ci, il constate qu’une grenouille d’une autre espèce que la sienne prend son bain dans ce bassin merveilleux. En effet, de somptueux lotuz bleus inondent ce coin de la forêt d’une lumière harmonieuse et d’une odeur délicate. La grenouille inconnue se retourne enfin vers Zoubi, ayant remarqué sa présence. Ce dernier a un mouvement de recul face à cette dernière, qui a la peau de la même couleur que les fleurs autour d’elle, ce qui n’est vraiment pas commun.', '- Bonjour jeune homme, susurra la mystérieuse grenouille.- Euhm, je… B-bonjour ! Je ne voulais pas vous déranger madame, je suis à la recherche de fleurs et j’ai aperçu ce bassin au loin, explique Zoubi, légèrement paniqué.- Mais tu ne me déranges pas, au contraire ! Regarde, il y a de sublimes fleurs dans ce bassin : viens te baigner avec moi et tu en récupéreras quelques-unes après t’être relaxé dans cette eau si pure…- C’est-à-dire que j’ai déjà pris une douche et je…- Viens ! crie la créature bleue, hystérique.- Non mais je…- Baigne toi avec moi ! hurle-t-elle.', '    Zoubi, décontenancé par cette soudaine agressivité, recule mais trébuche sur un caillou. Miskine.    Dans la panique, il envisage d’abord de lancer ce caillou sur cette grenouille afin de l&#039;assommer, récupérer ces lotuz et se barrer de cette forêt une bonne fois pour toutes.    Ou alors, il peut aussi se prêter à son jeu, et se baigner avec elle et suivre sa proposition. Mais il a un mauvais pressentiment.    Finalement, Zoubi peut aussi prendre la fuite s’il arrive à se relever.    Que doit faire Zoubi ?', '', '', 'img_a1.jpg', '', '', '', ''),
('A1', 35, 'Mhm, elles ont effectivement choisi ces couleurs, bien joué...', NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL),
...
('A1B2', 13, '- D’accord, d’accord ! s’écrie Zoubi, apeuré. Je vais venir me baigner avec vous.    Zoubi pose son sac au bord du bassin et vient tremper ses pattes palmées dans l’eau bleue.- Tu vois, je t’avais dit que ce serait agréable, roucoule la grenouille bleue. Tu comprends, je suis seule ici, personne ne vient jamais… Ça me fait plaisir d’avoir un peu de compagnie.- O-ouais, je comprends… balbutie le jeune homme, décontenancé. Bon, du coup, vous ne m&#039;en voulez pas hein, mais je vais récupérer un ou deux lotuz moi…    Zoubi s’exécute et sort de l’eau. Mais ses pieds ont changé de couleur : ils sont tout bleus. Et en y regardant de plus près, la teinte se répand jusqu’à ses mollets. Ce bassin serait-il donc toxique ? Avant que Zoubi ait la réponse, il sent que la grenouille bleue le saisit par la patte, et le fait plonger tout entier dans le bassin.    Ses parents lui avaient pourtant dit de ne pas parler aux inconnus…', '', '', '', '', 'img_a1b2.jpg', '', '', '', ''),
...
('A2', 35, '... Non, il fallait mieux regarder...', '', '', '', '', '', NULL, NULL, NULL, NULL),
...
('A3', 35, '... Bah non, y\'a que du vert...', NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL);
...
(20, 0, 'testUser', '$2y$10$YS8YmkHPZpFqAzHHE5s7xeS3vn6n42ICvfwf2zyc/9Jelj6rwqpBy'),
(21, 0, 'testUser2', '$2y$10$lRjEngGEXfyxTSDxd8/os.5T.f5DePa7Xbzzfxzc./82WIG2bjqg2'),
(22, 0, 'testUser3', '$2y$10$phCNmjSLV29LJ.03BWrSiORuY7MFWYKMxC1.r5QJ1pk0Bs6HNkkhO');
...
--
ALTER TABLE `histoire`
  MODIFY `id_hist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT pour la table `user`
--
ALTER TABLE `user`
  MODIFY `id_user` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
COMMIT;
